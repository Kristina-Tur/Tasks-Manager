...
import { todolistAPI } from "features/TodolistsList/services/todolistApi"
...
export const CreateTodolist = () => {
  const [state, setState] = useState<any>(null)
  useEffect(() => {
    todolistAPI.addTodolist("newTodolist").then((res) => {
      console.log({ res })
      setState(res.data)
    })
  }, [])
...
export const UpdateTodolistTitle = () => {
  ...
  useEffect(() => {
    todolistAPI.updateTodolistTitle(todolistId, "React").then((res) => {
      console.log({ res })
      setState(res.data)
    })
  }, [])
